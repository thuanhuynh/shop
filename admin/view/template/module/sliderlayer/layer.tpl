		...
		<div class="container-fluid">
			<div class="pull-right">
				<a class="btn btn-primary" onclick="$('#slider-form').submit();" class="button"><?php echo $button_save; ?></a>
      			...
      			<a class="btn btn-success hidden" id="btn-preview-ingroup" href="<?php echo  $objurl->link('module/pavsliderlayer/previewGroup', 'id='.$group_id.'&lang='.$lang.'&token=' . $objsession->data['token'], 'SSL');?>" class="button green" id="preview"><?php echo $objlang->get('Preview Sliders In Group');?></a>
			</div>
					...
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"  id="slider-form">
						...
						<div class="slider-toolbar clearfix">
							...
							<div class="buttons pull-right">
								<a class="btn btn-primary" onclick="$('#slider-form').submit();" class="button"><?php echo $button_save; ?></a> <a class="btn btn-success hidden" id="btn-preview-slider"><?php echo $objlang->get("text_preview_this_slider")?></a>
							</div>
