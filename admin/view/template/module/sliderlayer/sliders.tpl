		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul id="grouptabs" class="nav nav-tabs" role="tablist">
					...
					<li class="hidden"><a href="#tab-importtools" role="tab" data-toggle="tab"><?php echo $objlang->get('tab_import_tools');?></a></li>
				</ul>
							...
							<table class="table">
								<tr>
									...
									<td>
										<?php if( $id ) { ?> 
										<div class="buttons">
											<a class="btn btn-success btn-sm hidden" id="btn-preview-ingroup" href="<?php echo  $objurl->link('module/pavsliderlayer/previewGroup', 'id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>" class="button grey" id="preview"><?php echo $objlang->get('Preview Sliders In Group');?></a>
											...
											<a class="btn btn-warning btn-sm hidden" href="<?php echo  $objurl->link('module/pavsliderlayer/export', 'id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>"  class="btn orange" id="preview-sliders"><?php echo $objlang->get('Export Group And Sliders'); ?></a>
										</div>  
										<?php } ?>
									</td>   
								<tr>
