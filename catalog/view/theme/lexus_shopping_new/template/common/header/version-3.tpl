...
<nav id="topbar">
  ...
  <div class="container header-top space-margin-tb-20">
    <div class="inside">
      <div class="row">
        ...
        <div class="main-menu topbar-right col-xs-12 col-sm-6 col-md-6 col-lg-8 ">
          <!-- menu -->
          <div id="pav-mainnav" class="pav-mainnav"><div class="pav-megamenu">
            <button data-toggle="offcanvas" class="btn btn-success btn-xs hidden-lg hidden-md" type="button"><span class="fa fa-bars"></span> Menu</button>
  ...
  <div class="header-bottom">
    <div class="container">
      <div class="row">
        <div class="hidden-sm hidden-xs col-xs-12 col-sm-3 col-md-3 col-lg-3 hidden-xs">
        <div class="veticalmenu">
           <div class="panel-default panel-v1">
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 text-center hidden-xs">
          <?php echo $cart; ?>       
        </div>
