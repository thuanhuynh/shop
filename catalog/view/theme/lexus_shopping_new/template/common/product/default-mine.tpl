	...
	<div class="product-meta">		  
		...
		<div class="right">		
			<div class="action">
				...
				<div class="cart">						
					<a class="btn btn-default btn-outline"   onclick="cart.addcart('<?php echo $product['product_id']; ?>');">
				...
				<?php } ?>
				<div class="compare">			
					<a class="btn btn-default btn-outline"  onclick="compare.addcompare('<?php echo $product['product_id']; ?>');" title="<?php echo $button_compare; ?>">
						<i class="fa fa-retweet"></i>
						<span><?php echo $button_compare; ?></span>
					</a>	
				</div>	
				<div class="wishlist">
					<a class="btn btn-default btn-outline"  onclick="wishlist.addwishlist('<?php echo $product['product_id']; ?>');"  title="<?php echo $button_wishlist; ?>">
