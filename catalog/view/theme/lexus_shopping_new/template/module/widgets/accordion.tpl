...
<div class="widget-accordion panel <?php $addition_cls?> <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>">
	<?php if( $show_title ) { ?>
	<div class="widget-heading panel-heading"><?php echo $heading_title?></div>
	<?php } ?>
	<div class="widget-inner panel-body">	<div id="accordion<?php $id?>" class="panel-group">
