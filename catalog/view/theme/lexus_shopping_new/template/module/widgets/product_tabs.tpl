...
<div class="widget-products producttabs panel <?php echo $addition_cls;?> <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>">
	...
	<div class="tab-content">
		<?php foreach( $tabs as $tab => $products ) {
			...
			?>
			<div class="tab-pane fade box-products owl-carousel-play product-grid  tabcarousel<?php echo $id; ?> slide" id="tab-<?php if($tabsstyle=='tab-2'){echo $tab.'-left-'.$id;}elseif($tabsstyle=='tab-3'){echo $tab.'-right-'.$id;;}else{echo $tab.$id;}?>" data-ride="owlcarousel">
