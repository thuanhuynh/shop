...
class PtsWidgetCountdownproduct2 extends PtsWidgetPageBuilder {

		public $name = 'countdownproduct2';
		public $group = 'product';
		
		public static function getWidgetInfo(){
			return  array('label' =>  ('Countdown Product2'), 'explain' => 'Create Product Ajax With multiple Language', 'group' => 'product'  );
		}
